...
5. Draft or edit through the Eng Mode Authoring a skill playbook (`eng-mode` `playbooks/authoring-a-skill.md`). Project placement is default. Use `disable-model-invocation: true` unless the user explicitly wants always-on matching.

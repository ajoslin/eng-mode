...
Every reply for a run that produced a trail ends with an "Attention" section. Lead with the reviewer agent name, then list each flag pointing to specific rows or moments. "No flags" is valid.

...
- Before exploring, implementing, or retrying, ask whether the lead needs the details or just the result and evidence. Prefer a worker for the latter, even when there is only one task. Keep trivial work inline and decisions with the lead.

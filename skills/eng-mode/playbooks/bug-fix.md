...
2. Trace the mechanism before proposing fixes. Use `how`, `why`, ADRs, LSP, and `debug`. A stubborn falsifiable search is a `/goal`. Require an explicit bound. Never edit the ruler.

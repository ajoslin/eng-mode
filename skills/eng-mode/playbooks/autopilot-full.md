...
6. With explicit full-autonomy authority, a clean current-head verdict, **and** Babysit's review-agent loop quiet on that SHA, merge through GitHub or **github-stack**. Operator-owned items wait.

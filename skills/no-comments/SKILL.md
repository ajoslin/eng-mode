---
name: no-comments
description: "Run the comment-sicko reviewer, fix accepted findings, and offer encodings for claimed constraints."
disable-model-invocation: true
---

# No comments

Dispatch the `comment-sicko` project agent. Act on accepted findings.

Authoring agents defend comments. Defer to the reviewer's fresh perspective.
...
1. Dispatch one `task` with `agent: "comment-sicko"`. Pass the scope. Do not restate its rules.
